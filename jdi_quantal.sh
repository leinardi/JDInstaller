...
PARTNER="deb http://archive.canonical.com/ubuntu quantal partner"
PARTNER_SRC="deb-src http://archive.canonical.com/ubuntu quantal partner"
PARTNER_SED='sed -i -e "s/# deb http:\/\/archive.canonical.com\/ubuntu quantal partner/deb http:\/\/archive.canonical.com\/ubuntu quantal partner/g" /etc/apt/sources.list'
PARTNER_SRC_SED='sed -i -e "s/# deb-src http:\/\/archive.canonical.com\/ubuntu quantal partner/deb-src http:\/\/archive.canonical.com\/ubuntu quantal partner/g" /etc/apt/sources.list'

BACKPORTS="deb http://it.archive.ubuntu.com/ubuntu/ quantal-backports main restricted universe multiverse"
BACKPORTS_SRC="deb-src http://it.archive.ubuntu.com/ubuntu/ quantal-backports main restricted universe multiverse"
BACKPORTS_SED='sed -i -e "s/# deb http:\/\/it.archive.ubuntu.com\/ubuntu\/ quantal-backports main restricted universe multiverse/deb http:\/\/it.archive.ubuntu.com\/ubuntu\/ quantal-backports main restricted universe multiverse/g" /etc/apt/sources.list'
BACKPORTS_SRC_SED='sed -i -e "s/# deb-src http:\/\/it.archive.ubuntu.com\/ubuntu\/ quantal-backports main restricted universe multiverse/deb-src http:\/\/it.archive.ubuntu.com\/ubuntu\/ quantal-backports main restricted universe multiverse/g" /etc/apt/sources.list'
...
GETDEB="deb http://archive.getdeb.net/ubuntu quantal-getdeb apps"
...
enable_repo "Ubuntu Quantal-Backports" "$BACKPORTS" "$BACKPORTS_SED"
enable_repo "Ubuntu Quantal-Backports (Sorgenti)" "$BACKPORTS_SRC" "$BACKPORTS_SRC_SED"
