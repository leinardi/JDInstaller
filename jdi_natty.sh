...
APPZ_REPO_UFFICIALI="avant-window-navigator avidemux banshee banshee-community-extensions build-essential bwm-ng cmatrix compizconfig-settings-manager conky ffmpeg filezilla finch fusion-icon gdebi gimp gmail-notify gnome-commander gnome-mplayer gparted gthumb gtk-recordmydesktop hardinfo hddtemp htop iotop k3b libreoffice lm-sensors mc meld mercurial mplayer msttcorefonts mumble nautilus-actions nautilus-image-converter nautilus-open-terminal nfs-common nfs-kernel-server p7zip p7zip-full p7zip-rar padevchooser pidgin powertop pwgen rar sensors-applet sloccount  smartmontools soundconverter sox startupmanager subtitleeditor subversion  tagtool tofrodos tree ubuntu-restricted-extras vdpau-va-driver vim vim-gtk vlc vlc-plugin-pulse zlib1g-dev sun-java6-plugin skype" #g15daemon tvtime me-tv eclipse texmaker texlive"

APPZ_ALTRI_REPO="$WXXCODECS libdvdcss2 ubuntu-tweak jdownloader faenza-icon-theme faenza-icons-mono faenza-extras"
...
PARTNER="deb http://archive.canonical.com/ubuntu natty partner"
PARTNER_SRC="deb-src http://archive.canonical.com/ubuntu natty partner"
PARTNER_SED='sed -i -e "s/# deb http:\/\/archive.canonical.com\/ubuntu natty partner/deb http:\/\/archive.canonical.com\/ubuntu natty partner/g" /etc/apt/sources.list'
PARTNER_SRC_SED='sed -i -e "s/# deb-src http:\/\/archive.canonical.com\/ubuntu natty partner/deb-src http:\/\/archive.canonical.com\/ubuntu natty partner/g" /etc/apt/sources.list'

BACKPORTS="deb http://it.archive.ubuntu.com/ubuntu/ natty-backports main restricted universe multiverse"
BACKPORTS_SRC="deb-src http://it.archive.ubuntu.com/ubuntu/ natty-backports main restricted universe multiverse"
BACKPORTS_SED='sed -i -e "s/# deb http:\/\/it.archive.ubuntu.com\/ubuntu\/ natty-backports main restricted universe multiverse/deb http:\/\/it.archive.ubuntu.com\/ubuntu\/ natty-backports main restricted universe multiverse/g" /etc/apt/sources.list'
BACKPORTS_SRC_SED='sed -i -e "s/# deb-src http:\/\/it.archive.ubuntu.com\/ubuntu\/ natty-backports main restricted universe multiverse/deb-src http:\/\/it.archive.ubuntu.com\/ubuntu\/ natty-backports main restricted universe multiverse/g" /etc/apt/sources.list'
...
GETDEB="deb http://archive.getdeb.net/ubuntu natty-getdeb apps"
...
enable_repo "Ubuntu Natty-Backports" "$BACKPORTS" "$BACKPORTS_SED"
enable_repo "Ubuntu Natty-Backports (Sorgenti)" "$BACKPORTS_SRC" "$BACKPORTS_SRC_SED"
