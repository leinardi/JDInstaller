...
APPZ_REPO_UFFICIALI="avant-window-navigator awn-applets-all banshee banshee-community-extensions build-essential bwm-ng cmatrix compizconfig-settings-manager conky ffmpeg filezilla finch fusion-icon gdebi gimp gmail-notify gnome-commander gnome-mplayer gnome-session-fallback gnome-system-tools gnome-tweak-tool gparted gthumb gtk-recordmydesktop hardinfo hddtemp htop iotop k3b libreoffice lm-sensors mc meld mercurial mplayer msttcorefonts mumble nautilus-actions nautilus-image-converter nautilus-open-terminal nfs-common nfs-kernel-server p7zip p7zip-full p7zip-rar pidgin powertop pwgen rar sloccount  smartmontools soundconverter sox startupmanager subtitleeditor subversion synaptic tagtool tofrodos tree ubuntu-restricted-extras vdpau-va-driver vim vim-gtk vlc vlc-plugin-pulse zlib1g-dev skype" #g15daemon tvtime me-tv eclipse texmaker texlive"

APPZ_ALTRI_REPO="$WXXCODECS libdvdcss2 jdownloader faenza-icon-theme faenza-icons-mono synapse"
...
PARTNER="deb http://archive.canonical.com/ubuntu oneiric partner"
PARTNER_SRC="deb-src http://archive.canonical.com/ubuntu oneiric partner"
PARTNER_SED='sed -i -e "s/# deb http:\/\/archive.canonical.com\/ubuntu oneiric partner/deb http:\/\/archive.canonical.com\/ubuntu oneiric partner/g" /etc/apt/sources.list'
PARTNER_SRC_SED='sed -i -e "s/# deb-src http:\/\/archive.canonical.com\/ubuntu oneiric partner/deb-src http:\/\/archive.canonical.com\/ubuntu oneiric partner/g" /etc/apt/sources.list'

BACKPORTS="deb http://it.archive.ubuntu.com/ubuntu/ oneiric-backports main restricted universe multiverse"
BACKPORTS_SRC="deb-src http://it.archive.ubuntu.com/ubuntu/ oneiric-backports main restricted universe multiverse"
BACKPORTS_SED='sed -i -e "s/# deb http:\/\/it.archive.ubuntu.com\/ubuntu\/ oneiric-backports main restricted universe multiverse/deb http:\/\/it.archive.ubuntu.com\/ubuntu\/ oneiric-backports main restricted universe multiverse/g" /etc/apt/sources.list'
BACKPORTS_SRC_SED='sed -i -e "s/# deb-src http:\/\/it.archive.ubuntu.com\/ubuntu\/ oneiric-backports main restricted universe multiverse/deb-src http:\/\/it.archive.ubuntu.com\/ubuntu\/ oneiric-backports main restricted universe multiverse/g" /etc/apt/sources.list'
...
GETDEB="deb http://archive.getdeb.net/ubuntu oneiric-getdeb apps"
...
enable_repo "Ubuntu Oneiric-Backports" "$BACKPORTS" "$BACKPORTS_SED"
enable_repo "Ubuntu Oneiric-Backports (Sorgenti)" "$BACKPORTS_SRC" "$BACKPORTS_SRC_SED"

#add-apt-repository ppa:tualatrix/ppa #Ubuntu-Tweak
add-apt-repository ppa:jd-team/jdownloader #JDownloader
#add-apt-repository ppa:tortoisehg-ppa/releases #TortoiseHg
#add-apt-repository ppa:awn-testing/ppa #AWN Testing
add-apt-repository ppa:synapse-core/ppa #Synapse
add-apt-repository ppa:tiheum/equinox #Faenza
#add-apt-repository ppa:ferramroberto/java #Java
...
#add-apt-repository ppa:uck-team/uck-stable #UCK
