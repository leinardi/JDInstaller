...
#
#
DISTRIBUZIONE="utopic"
VERSIONE="JDInstall 1.1404.0 ($DISTRIBUZIONE)"

APPZ_REPO_UFFICIALI="autofs build-essential bwm-ng calibre cmatrix compizconfig-settings-manager conky curl dconf-tools default-jdk dkms exfat-fuse exfat-utils filezilla finch flashplugin-installer gdebi gimp git gnome-backgrounds gnome-commander gnome-gmail gnome-mplayer gnome-search-tool gnome-session-fallback gnome-system-tools gnome-themes-standard gnome-tweak-tool gparted gthumb gtk-recordmydesktop gwakeonlan hardinfo hddtemp htop icedtea-plugin indicator-multiload inkscape inxi iotop jstest-gtk k3b libreoffice libsoil1 lm-sensors linux-headers-generic mc meld mercurial mplayer mumble nautilus-actions nautilus-dropbox nautilus-image-converter nautilus-open-terminal nfs-common nfs-kernel-server openjdk-7-jdk p7zip p7zip-full p7zip-rar pidgin powertop pavucontrol ppa-purge python-pip python-dev pwgen rar saidar sloccount skype smartmontools soundconverter sox subtitleeditor subversion synaptic tagtool tofrodos tree ttf-mscorefonts-installer ubuntu-restricted-extras unity-tweak-tool unshield vdpau-va-driver vim vim-gtk vlc vlc-plugin-pulse zlib1g-dev" #g15daemon tvtime me-tv eclipse texmaker texlive" #myunity ffmpeg synapse
